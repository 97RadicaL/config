...
print_info() {
    #info title
    prin "$(color 6)Model" "Thinkpad X220"
    info underline

    prin "$(color 6)OS" "Arch Linux"
    #prin "$(color 6)Model" "Thinkpad X220"
    info "WM" wm
    #prin "$(color 6)Terminal" "urxvt"
    prin "$(color 6)Packages" "927"
    ...
    info "Uptime" uptime
    info "CPU" cpu
    #prin "$(color 6)GPU" "Integrated Graphics"
...
#~/.config/herbstluftwm/wallpaper.jpg
